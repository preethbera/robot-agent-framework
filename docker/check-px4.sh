...
M5_SITL=1 python -m pytest -c agent-framework/pyproject.toml agent-framework/tests bindings/test/tests bindings/px4/tests tests
...
python -m mypy --config-file agent-framework/pyproject.toml agent-framework/src agent-framework/tests bindings/test/src bindings/test/tests bindings/px4/src bindings/px4/tests tests
